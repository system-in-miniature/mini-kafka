...
??? note "文件差异：tests/test_final_acceptance.py"
    ```diff
    diff --git a/tests/test_final_acceptance.py b/tests/test_final_acceptance.py
    new file mode 100644
    index 0000000000000000000000000000000000000000..615275812d590d995913e20dcc2926fa591b906a
    --- /dev/null
...
??? note "文件差异：tests/test_sloc_report.py"
    ```diff
...
??? note "支撑文件差异（3 个文件）"
    **`pyproject.toml`**
    ...
    index 967b41ed399c3d6c2ebc0cfad3a5920b43f4a303..2eaa10a6091cbc7269acce6f859207be9f78b6c5 100644
    --- a/pyproject.toml
    +++ b/pyproject.toml
    ...
    **`uv.lock`**
    ...
    index 87dacf94fe65a374bf83ff8f9558783457c0af1d..86008661bd45b6e54b6e9a7b72fbbc3caf0a1346 100644
    --- a/uv.lock
    +++ b/uv.lock
    @@ -2,6 +2,110 @@ version = 1
     revision = 3
    ...
    @@ -36,11 +255,81 @@ dev = [
     ...
     dev = [
    +    { name = "mkdocs-material", specifier = ">=9.6,<10" },
    ...
    +
     ...
     version = "4.16.0"
    @@ -130,3 +553,36 @@ sdist = { url = "https://files.pythonhosted.org/packages/f6/cc/6253133b5bb138fc3
     wheels = [
