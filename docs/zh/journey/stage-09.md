...
??? note "文件差异：tests/consumer/test_generation_fencing.py"
    ```diff
...
??? note "文件差异：tests/consumer/test_group_rebalance.py"
    ```diff
...
??? note "文件差异：tests/unit/test_assignor.py"
    ```diff
...
??? note "文件差异：src/minikafka/consumer/assignor.py"
    ```diff
...
??? note "文件差异：src/minikafka/consumer/group.py"
    ```diff
