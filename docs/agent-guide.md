...
Use this mode when you want Codex to guide one MiniKafka Stage interactively in
the terminal.

## 1. Open Codex in MiniKafka
...
Replace `03` with any Stage from `01` through `20`. Codex prepares the correct
