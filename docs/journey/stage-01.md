# Stage 01 · Deterministic foundations
...
??? note "File diff: tests/unit/test_primitives.py"
    ```diff
    diff --git a/tests/unit/test_primitives.py b/tests/unit/test_primitives.py
    new file mode 100644
    index 0000000000000000000000000000000000000000..94b8e24d44f7ad00142e0533f86d4d85251ea318
    --- /dev/null
...
??? note "File diff: src/minikafka/clock.py"
    ```diff
    diff --git a/src/minikafka/clock.py b/src/minikafka/clock.py
    new file mode 100644
    index 0000000000000000000000000000000000000000..f6d115b5c60f0e300981e6f0b9dbc2afd0492b1a
    --- /dev/null
    +++ b/src/minikafka/clock.py
    @@ -0,0 +1,27 @@
...
??? note "File diff: src/minikafka/config.py"
    ...
    new file mode 100644
    index 0000000000000000000000000000000000000000..57970d3c22428509b0b89b067ee2d5ab4daba27d
    --- /dev/null
...
??? note "File diff: src/minikafka/errors.py"
    ...
    new file mode 100644
    index 0000000000000000000000000000000000000000..b070c1827c7bb9fbd283e12f21ff8525531d52d2
    --- /dev/null
...
??? note "Supporting file diffs (3 files)"
    **`pyproject.toml`**
    ...
    new file mode 100644
    index 0000000000000000000000000000000000000000..967b41ed399c3d6c2ebc0cfad3a5920b43f4a303
    --- /dev/null
    +++ b/pyproject.toml
    @@ -0,0 +1,31 @@
    +[build-system]
    ...
    +
    +[project]
    +name = "minikafka-reference"
    +version = "0.1.0"
    +description = "Direct-first MiniKafka reference implementation"
    ...
    **`src/minikafka/__init__.py`**
    ...
    new file mode 100644
    index 0000000000000000000000000000000000000000..395317f1fefa08dfea7f098e2accd9392d8b0a25
    --- /dev/null
    ...
    **`uv.lock`**
    ...
    new file mode 100644
    index 0000000000000000000000000000000000000000..87dacf94fe65a374bf83ff8f9558783457c0af1d
    --- /dev/null
    +++ b/uv.lock
    @@ -0,0 +1,132 @@
    +version = 1
...
[Complete reference patch / 完整参考补丁](https://github.com/system-in-miniature/mini-kafka/blob/main/journey/stages/01-primitives/stage.patch)
